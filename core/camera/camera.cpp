...
Eigen::Vector3d Camera::worldToCamera(const Eigen::Vector3d& pw,
                                      const Sophus::SE3d& T_cw) const {
    return T_cw * pw;
}

Eigen::Vector3d Camera::cameraToWorld(const Eigen::Vector3d& pc,
                                      const Sophus::SE3d& T_cw) const {
...
Eigen::Vector3d Camera::pixelToCamera(const Eigen::Vector2d& px,
                                      double depth) const {
